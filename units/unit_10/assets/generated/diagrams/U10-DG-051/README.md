# U10-DG-051 — Capa temporal del caso
...
- **Reproducción:** ejecutar `u10_generate_diagrams.mjs U10-DG-051` con el Node.js del runtime de Codex.

## Caption sugerido

Capa temporal del caso. DG-050 + ventanas y trazas CH-014.

## Texto alternativo

Capa temporal del caso. DG-050 + ventanas y trazas CH-014. Orden de lectura: Líderes desde fuente a minigráfico.

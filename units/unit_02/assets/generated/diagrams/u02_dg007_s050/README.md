# U02-DG007-S050 — La energía cinética depende de la rapidez al cuadrado
...
- `u02_fig_050_007.svg`: fuente vectorial editable/importable.
- `u02_fig_050_007.png`: render individual de 2400 × 1100 px.
...
Duplicar la rapidez cuadruplica `E_c` para la misma masa. Elaboración propia a partir del libro del curso.

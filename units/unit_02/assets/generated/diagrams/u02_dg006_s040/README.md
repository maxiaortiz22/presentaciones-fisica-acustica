# U02-DG006-S040 — La fuerza de amortiguamiento es opuesta a la velocidad
...
- `u02_fig_040_006.svg`: fuente vectorial editable/importable.
- `u02_fig_040_006.png`: render individual de 2400 × 1100 px.
...
`b` caracteriza el modelo disipativo; no toda atenuación se debe a `b`. Elaboración propia a partir del libro del curso.

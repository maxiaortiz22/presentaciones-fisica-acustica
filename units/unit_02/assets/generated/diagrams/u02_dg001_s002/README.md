# U02-DG001-S002 — Dos lados, una membrana: ¿qué cambia?

**Clasificación obligatoria:** diagrama conceptual.

## Propósito

Una diferencia de presión puede producir una fuerza neta.

## Archivos

- `source.json`: geometría, IDs, textos y conectores editables.
- `script.py`: regeneración reproducible.
- `u02_fig_002_001.svg`: fuente vectorial editable/importable.
- `u02_fig_002_001.png`: render individual de 2400 × 1100 px.
...
Una diferencia de presión puede producir una fuerza neta. Elaboración propia a partir del libro del curso.

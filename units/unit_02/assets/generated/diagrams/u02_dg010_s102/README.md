# U02-DG010-S102 — Control dimensional de `c = √(γRT/M)`
...
- `u02_fig_102_010.svg`: fuente vectorial editable/importable.
- `u02_fig_102_010.png`: render individual de 2400 × 1100 px.
...
El cociente dentro de la raíz tiene dimensión de velocidad al cuadrado. Elaboración propia a partir del libro del curso.

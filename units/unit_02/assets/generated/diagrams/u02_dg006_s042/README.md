# U02-DG006-S042 — Cada término del balance representa un mecanismo
...
- `u02_fig_042_006.svg`: fuente vectorial editable/importable.
- `u02_fig_042_006.png`: render individual de 2400 × 1100 px.
...
La ecuación describe un instante; no resuelve por sí sola la evolución temporal. Elaboración propia a partir del libro del curso.

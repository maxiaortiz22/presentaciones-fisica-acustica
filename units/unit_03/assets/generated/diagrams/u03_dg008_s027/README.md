# U03-DG008-S027 — Matriz de parámetros del MAS
...
- `u03_fig_027_008.svg`: fuente vectorial editable principal.
- `u03_fig_027_008.png`: respaldo raster de alta resolución.
...
Matriz de parámetros del MAS. Recurso propio para U03-027.

# U03-DG017-S049 — Doble dependencia ξ(x,t)
...
- `u03_fig_049_017.svg`: fuente vectorial editable principal.
- `u03_fig_049_017.png`: respaldo raster de alta resolución.
...
Doble dependencia ξ(x,t). Recurso propio para U03-049.

# U03-DG004-S010 — Movimiento local y frente
...
- `u03_fig_010_004.svg`: fuente vectorial editable principal.
- `u03_fig_010_004.png`: respaldo raster de alta resolución.
...
Movimiento local y frente. Recurso propio para U03-010.

# U03-DG016-S046 — Cadena de calibración audiométrica
...
- `u03_fig_046_016.svg`: fuente vectorial editable principal.
- `u03_fig_046_016.png`: respaldo raster de alta resolución.
...
Cadena de calibración audiométrica. Recurso propio para U03-046.

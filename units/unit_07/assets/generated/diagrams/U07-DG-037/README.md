...
- **Editabilidad:** `u07_dg_037_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-037` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Prototipo estático del cono de confusión.

## Texto alternativo

Cabeza conceptual con dos posiciones sobre una misma superficie de ambigüedad; no es un render anatómico tridimensional.

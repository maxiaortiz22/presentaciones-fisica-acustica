...
- **Editabilidad:** `u07_dg_042_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-042` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Síntesis acumulativa de la Unidad 7.

## Texto alternativo

Seis nodos conectados en dos filas: señal, ambiente, transferencia, procesamiento, tarea y respuesta.

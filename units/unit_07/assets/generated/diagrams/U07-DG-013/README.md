...
- **Editabilidad:** `u07_dg_013_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-013` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Comparación entre nivel de presión, nivel de sonoridad y sonoridad.

## Texto alternativo

Tres columnas conceptuales distinguen símbolos, unidades y operaciones: medir, igualar y estimar razón.

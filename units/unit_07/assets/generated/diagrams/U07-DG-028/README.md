...
- **Editabilidad:** `u07_dg_028_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-028` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Ecuación anotada de pérdida de articulación de consonantes.

## Texto alternativo

Ecuación central ALCons igual cien por uno menos correctas sobre presentadas, con cuatro llamadas externas.

...
- **Editabilidad:** `u07_dg_036b_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-036B` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Cálculo de una cota didáctica de ITD.

## Texto alternativo

Cuatro pasos dividen cero coma ciento ochenta metros por trescientos cuarenta y tres metros por segundo y obtienen quinientos veinticinco microsegundos.

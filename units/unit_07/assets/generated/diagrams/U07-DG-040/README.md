...
- **Editabilidad:** `u07_dg_040_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-040` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Cinco pistas convergen en el agrupamiento de una fuente.

## Texto alternativo

Frecuencia y timbre, tiempo, espacio, atención y conocimiento convergen en agrupamiento perceptual.

...
- **Editabilidad:** `u07_dg_027_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-027` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

La curva U07-CH-009 recibe llamadas editables a inicio, menos sesenta decibeles e intervalo T sesenta.

## Texto alternativo

Gráfico de decaimiento con tres llamadas editables que señalan el inicio, la caída de sesenta decibeles y el intervalo T sesenta.

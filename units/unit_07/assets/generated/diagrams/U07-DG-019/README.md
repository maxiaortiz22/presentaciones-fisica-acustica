...
- **Editabilidad:** `u07_dg_019_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-019` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Banco conceptual de tres canales representativos.

## Texto alternativo

Una entrada espectral se bifurca hacia canales auditivos bajo, medio y alto; tres canales representan un banco mayor.

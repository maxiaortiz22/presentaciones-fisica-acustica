...
- **Editabilidad:** `u07_dg_005_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-005` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Tres tareas psicofísicas alternativas nacen de un estímulo controlado.

## Texto alternativo

Una caja de estímulo se bifurca sin cruces hacia tareas de detección, igualación y estimación.

...
- **Editabilidad:** `u07_dg_025b_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-025B` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Cálculo e interpretación limitada de una SNR de más ocho decibeles.

## Texto alternativo

Cuatro pasos muestran nivel de habla, nivel de ruido, resta y resultado positivo con advertencia.

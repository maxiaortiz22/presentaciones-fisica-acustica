...
- **Editabilidad:** `u07_dg_030b_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-030B` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Cálculo de retardo y límite perceptual del ejemplo.

## Texto alternativo

Cuatro pasos convierten seis coma ocho metros en diecinueve coma ocho milisegundos y advierten que no es un límite universal.

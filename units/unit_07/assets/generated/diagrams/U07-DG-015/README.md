...
- **Editabilidad:** `u07_dg_015_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-015` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Ecuación anotada del modelo introductorio entre fones y sones.

## Texto alternativo

Ecuación central de sonoridad en sones con cuatro llamadas a base dos, referencia de cuarenta fon, denominador de diez fon y unidad son.

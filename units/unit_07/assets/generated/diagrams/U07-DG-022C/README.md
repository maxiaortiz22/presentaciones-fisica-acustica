...
- **Editabilidad:** `u07_dg_022c_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-022C` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Matriz de mecanismos y condiciones que pueden combinarse.

## Texto alternativo

Seis celdas organizan competencia energética, informacional y cuatro moduladores.

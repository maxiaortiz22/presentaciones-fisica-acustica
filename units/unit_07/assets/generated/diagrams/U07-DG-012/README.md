...
- **Editabilidad:** `u07_dg_012_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-012` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Mapa de cuatro relaciones físico–perceptuales sin signos de igualdad.

## Texto alternativo

Ocho celdas organizadas en cuatro pares de magnitud física y atributo perceptual.

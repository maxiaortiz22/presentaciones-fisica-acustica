...
- **Editabilidad:** `u07_dg_012b_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-012B` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Enlaces secundarios recuerdan que las correspondencias no son uno a uno.

## Texto alternativo

Una señal acústica central se relaciona con altura tonal, sonoridad, timbre y duración.

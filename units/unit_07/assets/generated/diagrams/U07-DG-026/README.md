...
- **Editabilidad:** `u07_dg_026_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-026` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Alternativa estática de tres sílabas con colas temporales que se superponen.

## Texto alternativo

Tres cuadros temporales muestran sílabas sucesivas y colas crecientes; el esquema no codifica tiempos reales.

...
- **Editabilidad:** `u07_dg_017_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-017` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Ecuación anotada de elevación del umbral por enmascaramiento.

## Texto alternativo

Ecuación central M de la frecuencia objetivo igual umbral enmascarado menos umbral en quietud, con tres llamadas externas.

...
- **Editabilidad:** `u07_dg_034_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-034` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Geometría binaural conceptual con recorridos hacia ambos oídos.

## Texto alternativo

Fuente lateral y dos oídos unidos por recorridos distintos, con rótulos externos ITD e ILD.

...
- **Editabilidad:** `u07_dg_008_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-008` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Cadena de transferencia desde una referencia de campo hasta la presión próxima al tímpano.

## Texto alternativo

Cuatro etapas conectadas: campo, cabeza y pabellón, conducto auditivo externo y tímpano.

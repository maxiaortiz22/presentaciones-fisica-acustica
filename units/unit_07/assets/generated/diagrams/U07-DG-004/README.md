...
- **Editabilidad:** `u07_dg_004_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-004` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Marco operativo para interpretar cualquier resultado psicofísico.

## Texto alternativo

Cadena de estímulo, tarea y respuesta con una cuarta caja que recuerda el contexto del procedimiento.

...
- **Editabilidad:** `u07_dg_030_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-030` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Ecuación anotada del retardo entre llegada reflejada y directa.

## Texto alternativo

Ecuación central delta t igual diferencia de recorridos dividida por rapidez, con tres llamadas externas.

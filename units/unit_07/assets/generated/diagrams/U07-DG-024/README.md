...
- **Editabilidad:** `u07_dg_024_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-024` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Condiciones mínimas para interpretar un porcentaje de inteligibilidad.

## Texto alternativo

Cuatro grupos organizan estímulo, procedimiento, oyente y resultado porcentual.

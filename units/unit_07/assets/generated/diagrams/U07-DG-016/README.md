...
- **Editabilidad:** `u07_dg_016_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-016` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Mapa de los tres niveles usados al describir enmascaramiento.

## Texto alternativo

Una condición común se bifurca hacia umbral en quietud, nivel del enmascarador y umbral enmascarado.

...
- **Editabilidad:** `u07_dg_021_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-021` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Comparación temporal de tres relaciones entre máscara y objetivo.

## Texto alternativo

Tres cuadros alineados muestran enmascaramiento hacia atrás, simultáneo y hacia adelante con la misma escala visual.

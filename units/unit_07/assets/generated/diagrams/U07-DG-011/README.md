...
- **Editabilidad:** `u07_dg_011_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-011` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Proceso conceptual de construcción de una curva de igual sonoridad.

## Texto alternativo

Cinco etapas conectadas: referencia de un kilohertz, tono de prueba, ajuste de nivel, juicio de igual sonoridad y registro del punto.

...
- **Editabilidad:** `u07_dg_026b_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-026B` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Mapa causal cualitativo de ruido, reverberación e inteligibilidad.

## Texto alternativo

Ruido, reverberación e interacción convergen en un resultado de reconocimiento de habla.

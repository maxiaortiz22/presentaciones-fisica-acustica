...
- **Editabilidad:** `u07_dg_014_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-014` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Construcción conceptual de las referencias de fon y son.

## Texto alternativo

Cuatro etapas conectan tono de un kilohertz, igualdad de sonoridad, nivel en fones y referencia cuarenta fon equivalente a un son.

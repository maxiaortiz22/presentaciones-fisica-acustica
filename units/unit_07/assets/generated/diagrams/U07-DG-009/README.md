...
- **Editabilidad:** `u07_dg_009_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-009` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Ecuación anotada de diferencia campo–tímpano.

## Texto alternativo

Ecuación central G sub CT igual nivel en tímpano menos nivel de campo, con tres llamadas externas.

...
- **Editabilidad:** `u07_dg_033b_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-033B` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Síntesis del bloque de reflexiones y precedencia.

## Texto alternativo

Cuatro etapas conectan geometría, retardo, condiciones del caso y respuesta perceptual.

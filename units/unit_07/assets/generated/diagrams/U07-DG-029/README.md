...
- **Editabilidad:** `u07_dg_029_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-029` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Geometría conceptual de recorridos directo y reflejado.

## Texto alternativo

Fuente, superficie y oyente con dos recorridos visualmente distintos y rótulos r sub d y r sub r.

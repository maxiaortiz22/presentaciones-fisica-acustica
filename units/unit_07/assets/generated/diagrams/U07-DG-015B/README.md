...
- **Editabilidad:** `u07_dg_015b_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-015B` con `U07_ARTIFACT_WORKSPACE` configurado.
...
Cuatro pasos convierten setenta fon en exponente tres, potencia dos al cubo y resultado ocho sones.

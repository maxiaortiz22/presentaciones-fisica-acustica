...
- **Editabilidad:** `u07_dg_020_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-020` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

La curva U07-CH-008 se combina con llamadas editables para definir la anchura rectangular equivalente.

## Texto alternativo

Gráfico de respuesta gaussiana y rectángulo equivalente con tres llamadas externas a altura, área y ancho.

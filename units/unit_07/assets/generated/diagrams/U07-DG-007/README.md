...
- **Editabilidad:** `u07_dg_007_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-007` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Geometría mínima para definir una medición de campo sin oyente.

## Texto alternativo

Fuente, dirección de propagación y punto de campo conectados horizontalmente; el esquema declara que no está a escala.

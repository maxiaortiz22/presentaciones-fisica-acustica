...
- **Editabilidad:** `u07_dg_028b_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-028B` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Síntesis del bloque de inteligibilidad sin reducirlo a SNR o T₆₀.

## Texto alternativo

Cuatro etapas conectan señal, ambiente, tarea y oyente, y resultado observado.

...
- **Editabilidad:** `u07_dg_023_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-023` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Escena conceptual de dos voces con rutas distinguibles por color, rótulo y patrón.

## Texto alternativo

Una respuesta central se relaciona con voz objetivo, voz competidora y atención; las rutas no dependen solo del color.

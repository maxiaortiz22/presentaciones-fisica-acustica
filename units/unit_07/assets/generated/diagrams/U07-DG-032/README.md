...
- **Editabilidad:** `u07_dg_032_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-032` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Familia de tareas asociadas al efecto de precedencia.

## Texto alternativo

Dos llegadas físicas se bifurcan hacia tareas de fusión, localización y discriminación.

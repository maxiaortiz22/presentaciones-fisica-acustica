...
- **Editabilidad:** `u07_dg_025_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-025` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Ecuación anotada de relación señal–ruido.

## Texto alternativo

Ecuación central SNR igual nivel de habla menos nivel de ruido, con cuatro llamadas externas.

...
- **Editabilidad:** `u07_dg_009b_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-009B` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Cálculo de una diferencia campo–tímpano para una frecuencia y dos posiciones definidas.

## Texto alternativo

Cuatro pasos: datos de cincuenta y cincuenta y ocho decibeles SPL, resta, resultado de ocho decibeles y límite interpretativo.

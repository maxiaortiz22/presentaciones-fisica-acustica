...
- **Editabilidad:** `u07_dg_006_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-006` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Seis condiciones delimitan el alcance de un resultado psicofísico.

## Texto alternativo

Un resultado central se relaciona con señal, nivel, tarea, ambiente, oyente y procedimiento.

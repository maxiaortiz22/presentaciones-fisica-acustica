...
- **Editabilidad:** `u07_dg_039_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-039` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Tres fuentes convergen en una mezcla binaural y luego se organizan en objetos perceptuales.

## Texto alternativo

Voz objetivo, competidora y ambiente convergen en una mezcla de ambos oídos y se relacionan con objetos perceptuales.

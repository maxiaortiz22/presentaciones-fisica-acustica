...
- **Editabilidad:** `u07_dg_020b_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-020B` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Cadena funcional desde estímulo hasta decisión mediante un canal auditivo conceptual.

## Texto alternativo

Cuatro etapas conectan estímulo, canal auditivo, salida interna y tarea perceptual.

...
- **Editabilidad:** `u07_dg_018_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-018` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Alternativa estática para mostrar la superposición temporal de objetivo y máscara.

## Texto alternativo

Tres cuadros temporales muestran objetivo, máscara y su intervalo de solapamiento; las duraciones son esquemáticas.

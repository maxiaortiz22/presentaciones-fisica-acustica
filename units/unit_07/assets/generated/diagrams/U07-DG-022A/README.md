...
- **Editabilidad:** `u07_dg_022a_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-022A` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Ruta funcional del enmascaramiento energético.

## Texto alternativo

Cuatro etapas conectan señales físicas, canales solapados, señal interna con menor contraste y respuesta.

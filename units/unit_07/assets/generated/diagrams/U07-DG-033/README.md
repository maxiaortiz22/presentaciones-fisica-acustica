...
- **Editabilidad:** `u07_dg_033_master.pptx` conserva textos, cajas y conectores; `diagram_source.json` conserva geometría, IDs y semántica.
- **Reproducción:** ejecutar `units/unit_07/scripts/u07_generate_diagrams.mjs U07-DG-033` con `U07_ARTIFACT_WORKSPACE` configurado.

## Caption sugerido

Comparación entre una regla simplificada y una formulación condicionada del efecto Haas.

## Texto alternativo

Dos paneles contrastan una igualdad universal incorrecta con un caso histórico condicionado.

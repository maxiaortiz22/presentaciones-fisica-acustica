# Guía transversal de notación — borrador

**Propósito:** evitar cambios de símbolos, unidades y criterios de nivel entre unidades. La guía conserva la notación del libro cuando es consistente y propone calificadores solo donde existe ambigüedad.
...
| trabajo | `W_\mathrm{trab}` | J | 2 | Calificar si comparte contexto con potencia acústica o watt. |
